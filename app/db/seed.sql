...
VALUES (
'Catch Me If You Can',
'Leonardo DiCaprio, Tom Hanks, Christopher Walken, Martin Sheen, Nathalie Baye, Amy Adams, James Brolin, Brian Howe, Frank John Hughes, Steve Eastin, Chris Ellis, John Finn, Jennifer Garner, Nancy Lenehan, Ellen Pompeo, Elizabeth Banks',
...
'https://m.media-amazon.com/images/M/MV5BNzQzMzJhZTEtOWM4NS00MTdhLTg0YjgtMjM4MDRkZjUwZDBlXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_SY1000_CR0,0,671,1000_AL_.jpg',
13
);
...
'https://m.media-amazon.com/images/M/MV5BODViZDg3ZjYtMzhiYS00YTVkLTk4MzktYWUxMTlkYjc1NjdlXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_SY1000_CR0,0,674,1000_AL_.jpg',
14
);
...
INSERT INTO reviews (review_desc, movie_id, rating)
VALUES ('The best movie Marvel has produced yet.', 11, 5);

INSERT INTO reviews (review_desc, movie_id, rating)
VALUES ('Forrest Gump isnt the one running this time', 12, 4);

INSERT INTO reviews (review_desc, movie_id, rating)
VALUES ('Young Harrison Ford is such a hotty', 13, 4);
